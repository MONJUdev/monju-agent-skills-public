...
version: 2026-07-04-void-label
status: active
portal_url: https://monjupartners.odoo.com/monju-au-rep
source_sha256: b28b09967aac2b19d63d2ab694697d3bfdf9ae50b334ef25dfbc843ecafdc5f1
owner: Monju
---
...
- delete evidence or overwrite audit-critical history, except for the approved
  ...
  from the rep workspace, or void mistaken activity evidence while preserving
  Monju audit control;
...
| Void evidence | `void-activity-evidence --json @void-evidence.json` | `x_monju_au_rep_evidence.write` | Void mistaken evidence without hard-deleting the audit trail. |
...
- voiding mistaken activity evidence hides it from the rep's normal activity
